...
from CVD_Net.run.default_configuration import get_default_configuration
from nnunet.paths import default_plans_identifier
from nnunet.training.cascade_stuff.predict_next_stage import predict_next_stage
from CVD_Net.training.network_training.nnUNetTrainer import nnUNetTrainer
...
def main():
    ...
    parser.add_argument("-outpath", type=str, default='Trainer_CVD_Net', help='output path')
    ...
    trainer_class = get_default_configuration(outpath, network, task, network_trainer, plans_identifier, \
                                              search_in=(CVD_Net.__path__[0], "training", "network_training"), \
                                              base_module='CVD_Net.training.network_training')
